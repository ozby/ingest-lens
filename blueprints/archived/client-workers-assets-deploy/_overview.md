...
type: blueprint
owner: ozby
title: "Client deploy via Workers Assets (pure-static)"
status: archived
complexity: S
created: "2026-04-24"
...
| Downstream | `foundation-hardening-100`    | Shipping a visible SPA at `dev.ingest-lens.ozby.dev` likely surfaces more audit concerns (auth UX, input validation on the client, error surfaces). Flag for review after deploy.                                                                                                                                                                                     |
